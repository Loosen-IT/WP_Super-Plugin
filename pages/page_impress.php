...
<div class="container-fluent pt-3" style="background-color:<?php get_database_value('super_color','color_back')?>">
    ...
    <div class="row p-2 pb-4 pe-4">
        ...
        <div class="col-4">
            <div class="card">
                <img src="<?php echo plugin_dir_url(__DIR__).'/pages/source/loosen-it.png'; ?>" height="220" width="480" class="card-img-top">
                <div class="card-body">
        ...
        <div class="col-4">
            <div class="card">
                <img src="<?php echo plugin_dir_url(__DIR__).'/pages/source/feldmann.jpg'; ?>" height="220" width="480" class="card-img-top">
                <div class="card-body">
